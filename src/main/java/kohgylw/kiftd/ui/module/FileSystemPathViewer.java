...
public class FileSystemPathViewer extends KiftdDynamicWindow {
	...
	private FileSystemPathViewer() {
		...
		addBtn.setPreferredSize(new Dimension((int) (140 * proportion), (int) (35 * proportion)));
		changeBtn.setPreferredSize(new Dimension((int) (120 * proportion), (int) (35 * proportion)));
		changeBtn.setEnabled(false);
		removeBtn.setPreferredSize(new Dimension((int) (120 * proportion), (int) (35 * proportion)));
					...
					if (mainFileSystemPathChooer.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
						...
						if (selectPath.isDirectory() && selectPath.canWrite() && selectPath.canRead()) {
							if (!SettingWindow.extendStores.parallelStream()
								...
								if (new File(ConfigurationManager.instance().getInitFileSystemPath()).equals(selectPath)
		...
		pathsTable.setRowHeight((int) (22 * proportion));
