...
public class KiftdDynamicWindow {
	 ...
	 * 设置窗口的最小尺寸约束（基于比例缩放）
	 */
	protected void setMinSize(Window window, int baseWidth, int baseHeight) {
		window.setMinimumSize(new Dimension((int) (baseWidth * proportion), (int) (baseHeight * proportion)));
	}
